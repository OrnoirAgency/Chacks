package com.ornoiragency.chacks.CustomView;
...
import com.ornoiragency.chacks.Utils.AnimUtil;
import com.ornoiragency.chacks.Utils.CommonUtils;
...
public class RecordAudio extends RelativeLayout {
    ...
    public void onActionDown(RecordMicButton recordMicButton, Context context) {
        ...
        if (recordListener != null) {
            if (CCPermissionHelper.hasPermissions(context, ChatActivity.RECORD_PERMISSION)) {
                recordListener.onStart();
            } else {
                CCPermissionHelper.requestPermissions(((Activity) context), ChatActivity.RECORD_PERMISSION,
                        ChatActivity.RECORD_CODE);
            }
        }
